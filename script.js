document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            navArtistProfile: "Perfil", navArtistProjects: "UX/UI",
            ...
            artistMetric1Title: "+20", artistMetric1Desc: "Conceptos y propuestas visuales desarrolladas.", artistMetric2Title: "UX + Branding", artistMetric2Desc: "Procesos centrados en usuario y narrativa de marca.", artistMetric3Title: "End-to-End", artistMetric3Desc: "Desde discovery hasta prototipos listos para desarrollo.",
            uxProjectsTitle: "Proyectos UX/UI", uxProject1Title: "Onboarding Fintech App", uxProject1Desc: "Rediseño completo de onboarding mobile para reducir abandono y mejorar activación en primeros 3 minutos.", uxProject2Title: "E-commerce de Moda", uxProject2Desc: "Arquitectura de información, diseño visual y prototipo de checkout optimizado para mobile-first.", uxProject3Title: "Dashboard SaaS B2B", uxProject3Desc: "Sistema de componentes y vistas de analítica para mejorar lectura de datos y toma de decisiones.",
            artistToolsTitle: "Herramientas que uso",
        ...
        en: {
            ...
            navArtistProfile: "Profile", navArtistProjects: "UX/UI",
            ...
            artistMetric1Title: "+20", artistMetric1Desc: "Visual concepts and proposals developed.", artistMetric2Title: "UX + Branding", artistMetric2Desc: "Processes centered on user needs and brand storytelling.", artistMetric3Title: "End-to-End", artistMetric3Desc: "From discovery to development-ready prototypes.",
            uxProjectsTitle: "UX/UI Projects", uxProject1Title: "Fintech App Onboarding", uxProject1Desc: "Complete mobile onboarding redesign to reduce drop-off and improve activation in the first 3 minutes.", uxProject2Title: "Fashion E-commerce", uxProject2Desc: "Information architecture, visual design, and a mobile-first optimized checkout prototype.", uxProject3Title: "B2B SaaS Dashboard", uxProject3Desc: "Component system and analytics views to improve data readability and decision-making.",
            artistToolsTitle: "Tools I use",
